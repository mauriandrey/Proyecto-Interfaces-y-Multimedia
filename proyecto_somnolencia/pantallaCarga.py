...
def show_loading_screen():
    ...
    def close_loading_window():
        # Cierra la pantalla de carga pero no destruye el root
        loading_window.destroy()
        root.deiconify()  # Muestra la ventana principal (root)
        # Ahora, se pasa el root existente a MainInterface para que use la misma instancia de Tk
        main_app = MainInterface(root)
        main_app.run()
